...
(function(win) {
	...
	Pagination.prototype.setShowPageNum = function(number) {
		this._showPageNum = number;
	}
	
	Pagination.prototype.setMoveStepSize = function(number) {
		this._moveStepSize = number;
	}
	...
	Pagination.prototype._gotoPage = function(clickpage, tarObj) {
		...
		if (Object.prototype.toString.call(tarpage) === "[object Number]" && tarpage === tarpage) {
			this._callback(tarpage);
		}
		this._freshUI(tarpage, tarObj);
	}
	...
	Pagination.prototype._init = function(){
		...
		content +=  "</span>";
		content +=  "<a data-page='-3' href='javascript:void(0)'>下一页</a>";
		content +=  "<a data-page='-2' href='javascript:void(0)'>末页</a>" + "<strong>共" + this._totalpage + "页</strong>";
		content += "</div>";
		content = "<a data-page='-4' href='javascript:void(0)'>上一页</a>".concat(content);
		content = "<a data-page='-5' href='javascript:void(0)'>首页</a>".concat(content);
	...
	Pagination.prototype._freshUI = function(tarpage, tarObj){
		var father = this._el;
